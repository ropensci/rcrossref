...
If you are intending to access crossref regularly you will want to register your email address with Crossref. This has the advantage that your queries are placed in the polite pool of servers and is good practice as described in the Crossref documentation under [Good manners](https://github.com/CrossRef/rest-api-doc). The second advantage is that Crossref can contact you if there is a problem with a query.

Details on how to register your email in a call can be found at `?rcrossref-package`. To pass your email address to Crossref, simply store it as environment variable in .Renviron like this:
