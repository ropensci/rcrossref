...
#' \url{http://www.crossref.org/openurl/}, their DOI Content Negotiation  service at
#' \url{http://www.crosscite.org/cn/}, and the \emph{Text and Data Mining} project 
#' \url{http://tdmsupport.crossref.org/}.
#' 
