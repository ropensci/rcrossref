...
test_that("cr_journals warns correctly", {
  ...
  expect_equal(NROW(suppressWarnings(cr_journals(issn = c('blblbl', '1932-6203')))$data), 0)
...
test_that("ISSNs that used to fail badly - should fail better now", {
  ...
  expect_equal(NROW(suppressMessages(suppressWarnings(cr_journals(c('1932-6203', '1803-2427', "0413-6597"))))$data), 0)
})
